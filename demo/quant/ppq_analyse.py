...
with ENABLE_CUDA_KERNEL():
    quantized = quantize_torch_model(
        ...
        onnx_export_file='/home/mzt/projects/yolov7/quant/output/mobilenet-v2.onnx', device=DEVICE, verbose=0)
    ...
    report.to_csv('/home/mzt/projects/yolov7/quant/output/1.csv')
